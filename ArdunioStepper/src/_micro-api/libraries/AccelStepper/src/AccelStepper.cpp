...
StepperButton::StepperButton(int pin): StepperButton(pin, INTERNAL_PULLUP) {};

StepperButton::StepperButton(int pin, int mode) 
{
	btnPin = pin;
	debounceTime = 0;
	count = 0;
...
void StepperButton::setDebounceTime(unsigned long time) 
{
	debounceTime = time;
}

int StepperButton::getState(void) 
{
	return lastSteadyState;
}

int StepperButton::getStateRaw(void) 
{
	return digitalRead(btnPin);
}

bool StepperButton::isPressed(void) 
{
...
bool StepperButton::isReleased(void) 
{
...
void StepperButton::setCountMode(int mode) 
{
	countMode = mode;
}

unsigned long StepperButton::getCount(void) 
{
	return count;
}

void StepperButton::resetCount(void) 
{
	count = 0;
}

void StepperButton::loop(void) 
{
